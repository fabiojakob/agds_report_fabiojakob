...
```
```{r}
source("C:/Users/fabio.LAPTOP-FR4VQFHF/Documents/agds_report_fabiojakob/Functions/re_ml_01_eval_model.r")
```
...
1. Hypothesis for k approaching 1:
   ...
   - MAE: MAE on the training set would decrease, while MAE on the test set would increase due to increased sensitivity      
